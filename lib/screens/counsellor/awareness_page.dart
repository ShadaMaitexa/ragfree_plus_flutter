...
class CounsellorAwarenessPage extends StatefulWidget {
  ...
  @override
  State<CounsellorAwarenessPage> createState() =>
      _CounsellorAwarenessPageState();
}

class _CounsellorAwarenessPageState extends State<CounsellorAwarenessPage> {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Best practices and guidelines for supporting students',
  ...
  Widget _buildContent(BuildContext context) {
    return StreamBuilder<List<AwarenessModel>>(
      stream: _awarenessService.getAwarenessForRole('counsellor'),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'No counselling guidance yet',
                    style: Theme.of(context).textTheme.titleMedium,
                  ),
                  const SizedBox(height: 8),
                  Text(
                    'Admins can publish standard protocols and reference material for counsellors from the Awareness Management module.',
