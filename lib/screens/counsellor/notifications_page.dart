...
class CounsellorNotificationsPage extends StatefulWidget {
  const CounsellorNotificationsPage({super.key});

  @override
  State<CounsellorNotificationsPage> createState() =>
      _CounsellorNotificationsPageState();
}

class _CounsellorNotificationsPageState
    extends State<CounsellorNotificationsPage>
